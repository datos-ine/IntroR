...
En este curso virtual autogestionado se combinarán clases teóricas con ejercicios prácticos y actividades de análisis de datos reales. En las clases teóricas (diapositivas explicadas en videos y lecturas on-line) se presentarán conceptos del lenguaje y de gestión de datos.

En las clases prácticas, los estudiantes aplicarán los conocimientos adquiridos a través de ejercicios para posteriormente pasar a su evaluación. Estas prácticas se llevaran a cabo en forma on-line con [Google Colaboratory](https://research.google.com/colaboratory/faq.html) y localmente a través de [RStudio](https://es.wikipedia.org/wiki/RStudio).
...
-   Hadley Wickham, Mine Cetinkaya-Rundel, Garrett Grolemund (2023). R for Data Science. Second Edition. *Disponible en* <https://r4ds.hadley.nz/>

-   Gema Fernández-Avilés, José-María Montero (2024). Fundamentos de ciencia de datos con R. *Disponible en* <https://cdr-book.github.io/index.html>

-   Rojas-Jimenez, K. (2022). Ciencia de Datos para Ciencias Naturales. *Disponible en* <https://bookdown.org/keilor_rojas/CienciaDatos/>

-   Neale Batra et al. (2021). Manual de R para Epidemiología. *Disponible en* <https://epirhandbook.com/es/index.html>

-   Tiffany Timbers, Trevor Campbell, Melissa Lee (2023). Data Science: A First Introduction. *Disponible en* <https://datasciencebook.ca/>

-   Russell A. Poldrack (2021). Statistical Thinking for the 21st Century. *Disponible en* <https://statsthinking21.github.io/statsthinking21-core-site/index.html>

-   Roger D. Peng, Elizabeth Matsui (2017). The Art of Data Science. *Disponible en* <https://bookdown.org/rdpeng/artofdatascience/>

-   Konstantinos I. Bougiouka (2024). Practical Statistics in Medicine with R. *Disponible en* <https://practical-stats-med-r.netlify.app/>
